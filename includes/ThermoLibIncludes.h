/*
 * Max31855Includes.h -- centralized location for external
 * includes, part of MaxThermo Thermocouple-to-digital
 ...
 * terms.
 */
#ifndef THERMO_TO_DIGITALCONV_LIB_INCLUDES_H_
#define THERMO_TO_DIGITALCONV_LIB_INCLUDES_H_


#include <inttypes.h>

#include "ThermoLibConfig.h"
#include "ThermoLibPlatform.h"

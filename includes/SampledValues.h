/*
 * SampledValues.h -- simple structure to hold thermo
 * and internal thermo-to-digital converter data,
...
#ifndef THERMO_TO_DIGITALCONV_LIB_SAMPLEDVALUES_H_
#define THERMO_TO_DIGITALCONV_LIB_SAMPLEDVALUES_H_
...
namespace MaxThermo
{
	...
	typedef uint32_t SampleRawDataInit;
